namespace SmartMedia
{
    partial class ModuleList
    {
        ...
        private void InitializeComponent()
        {
            ...
            // btnAddVideo
            // 
            btnAddVideo.BackColor = Color.DarkSeaGreen;
            btnAddVideo.ButtonType = XS.WinFormsTools.HelperCore.ButtonType.Default;
            btnAddVideo.ConerRadius = 16;
            btnAddVideo.Font = new Font("Segoe UI", 9F, FontStyle.Regular, GraphicsUnit.Point);
            btnAddVideo.Location = new Point(42, 6);
            btnAddVideo.Name = "btnAddVideo";
            btnAddVideo.Size = new Size(100, 35);
            btnAddVideo.TabIndex = 0;
            btnAddVideo.Text = "添加模块";
        ...
        private XS.WinFormsTools.XsButton btnAddVideo;
