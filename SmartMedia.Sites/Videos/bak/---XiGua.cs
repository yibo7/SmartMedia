...
//{
//    public class XiGua : VideoPushBase
//    {
//        override public int OrderIndex => 2;
//        protected override string UploadPage => "https://studio.ixigua.com";

//        public override string DataPage => "https://studio.ixigua.com/data";

//        public override string PluginName => "西瓜中视频";
//        override public Image IcoName => Resource.xigua;
//        override public async Task<string> LoginAsync()
//        {
//            return await LoginCustom("https://studio.ixigua.com", "div.img-wrapper");
//        }
