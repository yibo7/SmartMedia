...
//{
//    public class WeiBo : VideoPushBase
//    {
//        public override bool IsAllowPush => false; // 暂不支持发布
//        public override string CategoryFileName => "WeiboVideo.json";
//        protected override string UploadPage => "https://weibo.com/upload/channel";

//        public override string DataPage => "https://me.weibo.com/data/video";
...
//        {
//            //var fileXpath = "input[type=file]";
//            //await page.SetInputFilesAsync(fileXpath, model.video_path);
//            //// 等待文件加载完成
//            //await page.WaitForTimeoutAsync(2000); // 等待1秒钟，可以根据实际情况调整

//            //await page.GetByRole(AriaRole.Button, new() { Name = "上传视频", Exact = true }).ClickAsync();
//            //await page.WaitForLoadStateAsync(LoadState.NetworkIdle);


//            //var fileInput = await page.QuerySelectorAllAsync(fileXpath);
//            //var files = await fileInput.EvaluateAsync<string[]>("input => input.files.length > 0");

//            var fileXpath = "input[type=file]";
//            string filePath = model.file_path;// @"D:\瞬-钢琴谱.mp4";

//            // 设置文件路径
//            await page.SetInputFilesAsync(fileXpath, filePath);
//            PrintLog(filePath);
//            // 等待文件加载完成
//            await page.WaitForTimeoutAsync(5000); // 等待1秒钟，可以根据实际情况调整

//            /*
//             init 失败Emor: 
//Request failed with
//status code
//400error: 请求参数不合法(code:20380)
//             */
...
//                await page.SetInputFilesAsync(".upload-trigger-tip", model.img_path);
