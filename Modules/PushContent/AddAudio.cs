    ...
    public partial class AddAudio : XsDockContent
    {
        ...
        public AddAudio(PushInfo _model = null)
        {
            ...
            if (_model != null)
            {
                ...
                {
                    lbAudioName.Text = Path.GetFileName(CurrentVideoPath);
                }
        ...
        {
            CurrentVideoPath = Dialogs.OpenSelFile("选择音频文件|*.mp3;*.wav;*.flac;*.aac;*.m4a;*.ogg;*.opus;*.wma;*.amr;");
        ...
        private void btnPlay_Click(object sender, EventArgs e)
        {
            ...
            if(btnPlay.Text == "试听")
            {
                audioPlayer.Load(CurrentVideoPath);
                audioPlayer.Play();
                btnPlay.Text = "暂停";
            }
            else
